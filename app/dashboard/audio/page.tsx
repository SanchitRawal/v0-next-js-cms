...
import { Plus, Trash2, Edit, Eye, Music } from 'lucide-react'
      ...
      <div className="max-w-7xl">
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-2">Manage your audio content</p>
          </div>
        ...
        {loading ? (
          ...
          <Card className="p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-foreground">No audio files yet</h3>
            <p className="text-muted-foreground mt-2">Create your first audio content</p>
            <Link href="/dashboard/content/create" className="mt-4 inline-block">
              <Button variant="outline">Create Audio</Button>
            </Link>
          </Card>
        ) : (
